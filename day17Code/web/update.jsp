        ...
        <form action="${pageContext.request.contextPath}/updateServlet" method="post">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
                ...
                <input type="text" value="${user.username}" class="form-control" name="username" placeholder="请输入用户名"/>
            </div>

            <div class="form-group">
                <label for="password">密码：</label>
                <input type="text" value="${user.password}" class="form-control" name="password" placeholder="请输入密码"/>
            </div>
