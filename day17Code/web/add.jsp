...
<script>
    ...
    function checkUsername() {
        ...
        if (flag){
            s_username.innerHTML = "<img width='32px' height='32px' src='img/gou.png' />";
        } else {
    ...
    function checkPassword() {
        ...
        var zz = /^\w{6,18}$/;
        var flag = zz.test(password);
        if (flag){
            s_password.innerHTML = "<img width='32px' height='32px' src='img/gou.png' />";
        } else {
